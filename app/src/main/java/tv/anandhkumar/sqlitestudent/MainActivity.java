    ...
    private void deleteAllData() {
        buttonDeleteAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Integer deletedatas = myDB.deleteAllData();

                if (deletedatas >0){
                    Toast.makeText(getApplicationContext(),"All Record's Deleted",Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void updateData() {
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               boolean isUpdated =  myDB.updateData(id,editName.getText().toString(),
                ...
                if (isUpdated == true){
                    ...
                    Toast.makeText(getApplicationContext(),"OOPS.! Record Not Updated",Toast.LENGTH_SHORT).show();
                }
    ...
    private void deleteData() {
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Integer deleteRow = myDB.deleteData(id);
    ...
    private void viewAll() {
        buttonViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showMessage("Data's:",buffer.toString());
            }
        });
    }
    ...
    private void getData() {
        buttonGetData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.getCount()==0){
                    showMessage("Sorry","No records found for this ID");
                }
